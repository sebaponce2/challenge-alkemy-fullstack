            ...
            <section style={{height: '100vh'}}>
                <div className="mt-10">
                    ...
                    <h2 className="fw-bold text-center font-poppins font-black pb-4">Login</h2>
                        ...
                        <input className="d-block w-100 p-2 px-4 font-poppins my-auto text-center" type="email" name="mail" placeholder="Username"/>
                        ...
                        <div className="w-100 text-center">
                            <button className="border-0 fw-bold font-poppins bg-white">Register</button>
                        </div>
                    </form>
                </div>
            </section>
